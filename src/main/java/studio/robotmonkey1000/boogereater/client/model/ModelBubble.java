...
public class ModelBubble extends Model {
	...
	public ModelBubble() {
		...
		this.texWidth = 64;
		this.texHeight = 64;
		this.Bubble = new ModelPart(this, 64, 64);
...
//		this.Bubble.addBox(100, 100, 100, 100, 100, 100, 100);
	...
	@Override
	public void renderToBuffer(PoseStack matrix, VertexConsumer vertex, int packedLight, int packedOverlay, float r, float g, float b, float a) {
